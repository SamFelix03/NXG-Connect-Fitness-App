...
router.get('/:userId/branches', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)(['admin']), users_controller_1.getUserBranches);
...
router.get('/:userId/body-metrics', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)(['admin']), users_controller_1.getBodyMetrics);
router.put('/:userId/body-metrics', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)(['admin']), (0, audit_middleware_1.auditAuth)('BODY_METRICS_UPDATE'), sanitization_middleware_1.sanitizationMiddleware, (0, validation_middleware_1.validate)({ body: validation_1.bodyMetricsSchema }), users_controller_1.updateBodyMetrics, audit_middleware_1.completeAudit);
router.get('/:userId/body-metrics/history', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)(['admin']), (0, validation_middleware_1.validate)({ query: validation_1.bodyMetricsHistorySchema }), users_controller_1.getBodyMetricsHistory);
router.get('/:userId/privacy', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)(['admin']), users_controller_1.getPrivacySettings);
router.put('/:userId/privacy', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)(['admin']), (0, audit_middleware_1.auditAuth)('PRIVACY_SETTINGS_UPDATE'), sanitization_middleware_1.sanitizationMiddleware, (0, validation_middleware_1.validate)({ body: validation_1.privacySettingsSchema }), users_controller_1.updatePrivacySettings, audit_middleware_1.completeAudit);
...
router.get('/:userId/preferences', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)(['admin']), users_controller_1.getUserPreferences);
router.put('/:userId/preferences', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)(['admin']), (0, audit_middleware_1.auditAuth)('USER_PREFERENCES_UPDATE'), sanitization_middleware_1.sanitizationMiddleware, (0, validation_middleware_1.validate)({ body: validation_1.userPreferencesSchema }), users_controller_1.updateUserPreferences, audit_middleware_1.completeAudit);
router.post('/:userId/devices', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)(['admin']), rateLimit_middleware_1.generalRateLimit, (0, audit_middleware_1.auditAuth)('DEVICE_TOKEN_REGISTER'), sanitization_middleware_1.sanitizationMiddleware, (0, validation_middleware_1.validate)({ body: validation_1.deviceTokenSchema }), users_controller_1.registerDeviceToken, audit_middleware_1.completeAudit);
router.delete('/:userId/devices/:tokenId', auth_middleware_1.authenticateToken, (0, auth_middleware_1.requireRole)(['admin']), (0, audit_middleware_1.auditAuth)('DEVICE_TOKEN_REMOVE'), users_controller_1.removeDeviceToken, audit_middleware_1.completeAudit);
