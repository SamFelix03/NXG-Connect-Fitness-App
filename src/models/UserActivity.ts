...
UserActivitySchema.pre('save', function(next) {
  ...
  this['summary'].totalPoints = this['pointsEarned'].reduce((sum: number, point: any) => sum + point.points, 0);
  this['summary'].caloriesConsumed = this['dietActivity'].uploadedMeals.reduce((sum: number, meal: any) => sum + meal.calories, 0);
